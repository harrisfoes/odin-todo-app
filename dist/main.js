...
class UI {
    ...
    initStorage = () => {
        ...
        if (this.storage.containsStorage()) {
            ...
            todoList.getProjects().forEach((project) => project.setTasks(
                project.getTaskList().map((tasks) => Object.assign(new _todoParts_js__WEBPACK_IMPORTED_MODULE_0__.Task(), tasks)))
            );
    ...
    addNewTask = (evt) => {
        ...
        const newTask = new _todoParts_js__WEBPACK_IMPORTED_MODULE_0__.Task(title, desc, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(due), "MM/dd/yyyy"), "normal");
    ...
    editTaskDialog = (evt) => {
        ...
        dateInput.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(task.getDueDate()), "yyyy-MM-dd");
    ...
    editTask = (taskIndex) => {
        ...
        if (newDate != "") { 
            task.setDueDate((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(newDate), "MM/dd/yyyy")); 
        }
