...
const date = new Date();
console.log(date);
console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date, 'yyyy-MM-dd'));

const storage = new _storage_js__WEBPACK_IMPORTED_MODULE_1__.Storage("todoApp");
...
//start of todo app
const todoApp = new _todoParts_js__WEBPACK_IMPORTED_MODULE_0__.ProjectController("todoApp");
//default project
